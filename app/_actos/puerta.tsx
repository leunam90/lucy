...
const Puerta = ({ windowWidth, imageWidth, windowHeight }: Props) => {
  ...
  return (
    <section className="snap-start w-full flex-none bg-cover bg-center flex items-center justify-center overflow-hidden" style={{ height: altura, backgroundImage: `url('/puerta2.jpg')` }}>
