...
const Puerta = ({ windowWidth, imageWidth, windowHeight }: Props) => {
  ...
  return (
    <section className="md:hidden snap-start w-full flex-none bg-cover bg-center flex items-center justify-center overflow-hidden" style={{ height: altura, backgroundImage: `url('/inside.jpg')` }}>
      ...
      <audio ref={audioRef} src="/joy.mp3" />
    </section>
  );
};
